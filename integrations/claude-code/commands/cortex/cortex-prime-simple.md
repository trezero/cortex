---
name: prime-simple
description: Quick context priming for Cortex development - reads essential files and provides project overview
argument-hint: none
---

## Prime Context for Cortex Development

You need to quickly understand the Cortex V2 Beta codebase. Follow these steps:
...
- `cortex-ui/` - Frontend React application
...
Read these essential files in `cortex-ui/`:
...
1. **Project Purpose**: One sentence about what Cortex does and why it exists
