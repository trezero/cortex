          ...
          <div className="flex items-start gap-4">
            ...
            <div className="space-y-4 flex-1">
              ...
              <p className="text-red-200">
                The Cortex backend service failed to start. This is typically due to a configuration issue.
              </p>
              ...
              <div className="bg-black/50 rounded-lg p-4 border border-red-900/50">
                ...
                <p className="text-red-100 font-mono text-sm mb-3">
                  Check the <span className="text-red-400 font-bold">Cortex API server</span> container logs in Docker Desktop for detailed error information.
                </p>
                <div className="space-y-2 text-xs text-red-300">
                  <p>1. Open Docker Desktop</p>
                  <p>2. Go to Containers tab</p>
                  <p>3. Look for the Cortex server container (typically named <span className="text-red-400 font-semibold">cortex-server</span> or similar)</p>
