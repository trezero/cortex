...
const PROVIDER_MODELS_KEY = 'cortex_provider_models';
...
export const RAGSettings = ({
  ...
  useEffect(() => {
    ...
    window.addEventListener('cortex:credentials-updated', handleCredentialUpdate);

    return () => {
      window.removeEventListener('cortex:credentials-updated', handleCredentialUpdate);
    };
