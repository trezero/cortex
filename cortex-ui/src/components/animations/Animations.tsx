...
/**
 * CortexLoadingSpinner - A loading animation component with neon trail effects
 *
 * This component displays the Cortex logo with animated spinning circles
 ...
 */
export const CortexLoadingSpinner: React.FC<{
  size?: 'sm' | 'md' | 'lg';
  logoSrc?: string;
  className?: string;
}> = ({
