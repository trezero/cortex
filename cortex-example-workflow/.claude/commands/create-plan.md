...
If Cortex RAG is available and relevant:
- Use `mcp__cortex__rag_get_available_sources()` to see available documentation
- Search for relevant patterns: `mcp__cortex__rag_search_knowledge_base(query="...")`
- Find code examples: `mcp__cortex__rag_search_code_examples(query="...")`
