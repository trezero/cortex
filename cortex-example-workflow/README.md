# Cortex AI Coding Workflow Template

A simple yet reliable template for systematic AI-assisted development using **create-plan** and **execute-plan** workflows, powered by [Cortex](https://github.com/trezero/cortex) - the open-source AI coding command center. Build on top of this and create your own AI coding workflows!
...
- **Knowledge-augmented development** via Cortex's RAG capabilities
...
- Searches Cortex's knowledge base for best practices and patterns
...
Execute implementation plans with integrated Cortex task management and validation.

**What it does:**
- Reads your implementation plan
- Creates an Cortex project and tasks automatically
...
[Cortex](https://github.com/trezero/cortex) is an open-source AI coding OS that provides:
...
└── CLAUDE.md               # Cortex-first workflow rules
```
...
1. **Copy the template to your project:**
   ```bash
   cp -r use-cases/cortex-example-workflow/.claude /path/to/your-project/
   ```
...
2. Use Cortex's web UI for task management if MCP isn't available
...
# → AI searches Cortex knowledge base for JWT best practices
# → AI analyzes your codebase patterns
# → Generates PRPs/auth-api.md with 12 tasks

# 3. Execute plan
/execute-plan PRPs/auth-api.md
# → Creates Cortex project "Authentication API"
# → Creates 12 tasks in Cortex
...
# 3. Execute with existing Cortex project
...
- **Context retention**: Cortex keeps project history and patterns
